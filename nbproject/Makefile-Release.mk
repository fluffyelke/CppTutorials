...
${OBJECTDIR}/chapters/Fundamentals/Fundamentals.o: chapters/Fundamentals/Fundamentals.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Fundamentals/Fundamentals.o chapters/Fundamentals/Fundamentals.cpp
...
${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/ArithmeticType/C03Complex.o: chapters/Part1/C02AbstractMechanism/ArithmeticType/C03Complex.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/ArithmeticType/C03Complex.o chapters/Part1/C02AbstractMechanism/ArithmeticType/C03Complex.cpp
...
${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/Containers/C03Vector.o: chapters/Part1/C02AbstractMechanism/Containers/C03Vector.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/Containers/C03Vector.o chapters/Part1/C02AbstractMechanism/Containers/C03Vector.cpp
...
${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/Containers/ContainersExamples.o: chapters/Part1/C02AbstractMechanism/Containers/ContainersExamples.cpp
	${MKDIR} -p ${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/Containers
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/Containers/ContainersExamples.o chapters/Part1/C02AbstractMechanism/Containers/ContainersExamples.cpp
...
${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/Part2ExampleTest.o: chapters/Part1/C02AbstractMechanism/Part2ExampleTest.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Part1/C02AbstractMechanism/Part2ExampleTest.o chapters/Part1/C02AbstractMechanism/Part2ExampleTest.cpp
...
${OBJECTDIR}/chapters/Part1/C02TheBasics/C02Examples.o: chapters/Part1/C02TheBasics/C02Examples.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Part1/C02TheBasics/C02Examples.o chapters/Part1/C02TheBasics/C02Examples.cpp

${OBJECTDIR}/chapters/Part1/C02TheBasics/C02SomeTest.o: chapters/Part1/C02TheBasics/C02SomeTest.cpp
	${MKDIR} -p ${OBJECTDIR}/chapters/Part1/C02TheBasics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Part1/C02TheBasics/C02SomeTest.o chapters/Part1/C02TheBasics/C02SomeTest.cpp

${OBJECTDIR}/chapters/Part1/Part1ExamplesTest.o: chapters/Part1/Part1ExamplesTest.cpp
	${MKDIR} -p ${OBJECTDIR}/chapters/Part1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chapters/Part1/Part1ExamplesTest.o chapters/Part1/Part1ExamplesTest.cpp
