 ...
 * Author: default
 *
 * Created on February 29, 2024, 11:51 AM
 */

#ifndef ALLEXAMPLES_H
#define ALLEXAMPLES_H

namespace Examples {

    extern void mapExample();
    extern void FundamentalsTest();
    extern void part01Basics();
    extern void part02Abstractions();
    extern void part01Containers();
    extern void testComparator();
    extern void testUsefulFunctions();
    //Chapter 05 ConcurencyAndUtilities
    ...
    extern void examplesC12Functions();
    extern void excercisesC12Functions();
    
    //Chapter 13 Exceptions
    extern void examplesC13Exceptions();
    extern void excercisesC13Exceptions();
