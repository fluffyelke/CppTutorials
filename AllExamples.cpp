...
//        C11::ex02MemoryBadAllocThrow();
    ...
    void examplesC12Functions(){
        C12::testIota();
        excercisesC12Functions();
    }
    void excercisesC12Functions(){
        C12::ex01Result();
        C12::ex08();
        C12::ex09RevertArray();
    }
    
    void examplesC13Exceptions() {
        C13::vectorExamplev1();
        excercisesC13Exceptions();
    }
    void excercisesC13Exceptions() {
        
    }
    
    void examplesC16Classes() {
        C16Classes::c16Examples1();
